    ...
    _loginTitleHandle=()=>{
        return (
            <View style={styles.loginContentView}>
                <Text style={styles.loginTitleHandle}>Input Verification Code</Text>
                <Text style={styles.littleTitle}>Verification code has been sent</Text>
            </View>
        )
    }
    /**
    ...
    _emailAddressHandle=()=>{
        return (
            <View style={[styles.emailBox, styles.contentCommon]}>
                ...
                <Content style={styles.rightCon}>
                    <Image style={styles.icon1} source={Images.Img.close}/>
                    <Button  style={styles.btnColor} >pay</Button>
                </Content>
            </View>
        )
    }
    ...
    _emailButton=()=>{
        return (
            <View style={styles.contentCommon}>
                ...
                />
                <Text style={[styles.littleTitle,styles.textCenter]}>No verification code ? Retrievable after countdown</Text>
            </View>
        )
    }
    /**
